...
const AuthLayout = dynamic<AuthLayoutProps>(
  () => import("@/src/components/layouts/authLayout")
);
...
function Signup() {
  ...
  const onSubmit = async (data: any) => {
    ...
    if (response.status) {
      ...
      toast.success(`We have sent you email, Please verify your email!`);
